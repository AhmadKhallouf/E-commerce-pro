   ...
   <body>
      ...
      <div style="padding-left: 20%; padding-bottom:20px;">
         ...
         <div style="width:70%; padding-bottom:5px">
            <b style="padding-left: 5px;">{{ $comment->name }}</b>
            <p style="padding-left: 5px;">{{ $comment->comment }}</p>
            <a href="javascript::void(0)" onclick="reply(this)" style="color: blue; padding-left: 5px;" data-Commentid="{{ $comment->id }}">Reply</a>
         </div>

           @foreach ($replies as $reply )
            @if ($reply->comment_id == $comment->id)
         <div style="padding-left: 6%; padding-bottom:40px; ">
            <b style="color: red">{{ $reply->name }}</b>
            <p>{{ $reply->reply }}</p>
         </div>
            @endif
         @endforeach
         ...
         <div style="display: none; padding-left:5px;" class="replyDiv">
            ...
            <a href="javascript::void(0)" onclick="reply_close(this)" class="btn" style="color:blue;" >Close</a>
            </form>
         </div>
